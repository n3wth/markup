...
**YOU ARE IN: `markup/polecats/slit/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/markup/` (rig root) or other directories
...
**Your mail address:** `markup/polecats/slit`
**Your rig:** markup
**Your Witness:** `markup/witness`
...
| Ask Witness for help | `gt mail send markup/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`markup/witness`) when:
...
```bash
gt mail send markup/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
